...
<script type="text/javascript">
	$(function()
		...
		$(".Navigation_name li").eq(4).addClass("on");
			});
</script>
</head>
...
<!--品牌团购样式-->
 <div class="Inside_pages">
  ...
  <!--品牌-->
    <div class="buy_brands_logo">
      <div class="title_name"><img src="${pageContext.request.contextPath}/images/title_buy_03.png" /></div>
      <div class="brands_logo_list">
       <div class="hd"></div>
       <div class="bd">
        <ul>
         <li>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/690.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/740.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/741.png" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/1089.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/1145.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/1252.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/1270.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/1309.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/1663.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/6116.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/618.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/644.jpg" width="160"><span>欧珀莱</span></a>
         </li>
         <li>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/34.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/42.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/152.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/156.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/199.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/245.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/339.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/458.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/618.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/644.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/618.jpg" width="160"><span>欧珀莱</span></a>
          <a href="#" class="brand_logo"><img src="${pageContext.request.contextPath}/product/logo/644.jpg" width="160"><span>欧珀莱</span></a>
       ...
       <script type="text/javascript">
		jQuery(".brands_logo_list").slide({mainCell:".bd ul",trigger:"click"});
		</script>
    </div>
    <!--团购列表-->
    <div class="buy_brands_list">
    <div class="title_name"><img src="${pageContext.request.contextPath}/images/title_buy_06.png" /></div>
    <ul class="p_sell">
            	<li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_21.jpg" width="160" height="140"></div>
                    <div class="name" title="Olay玉兰油 多效修护霜50g（新老包装随机">Olay玉兰油 多效修护霜50g（新老包装随机发放） </div>
                    <div class="price">
                    	<table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                          <tbody><tr style="font-family:'宋体';">
                            <td width="33%">市场价 </td>
                            <td width="33%">折扣</td>
                            <td width="33%">为您节省</td>
                          </tr>
                    ...
                    <div class="ch_bg">
                        ...
                        <a href="javascript:void(0)" class="ch_a">查看</a>
                    </div>
                    <div class="times">倒计时：1200 时 30 分 28 秒</div>
                </li>
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_20.jpg" width="160" height="140"></div>
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_27.jpg" width="160" height="140"></div>
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_26.jpg" width="160" height="140"></div>
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_24.jpg" width="160" height="140"></div>
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_16.jpg" width="160" height="140"></div>
                    <div class="name">登机箱拉杆箱</div>
                    <div class="price">
                    	<table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                          <tbody><tr style="font-family:'宋体';">
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_13.jpg" width="160" height="140"></div>
                    <div class="name">粉色hp笔记本</div>
                    <div class="price">
                    	<table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                          <tbody><tr style="font-family:'宋体';">
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_2.jpg" width="160" height="140"></div>
                    <div class="name">苹果 Iphone 6S</div>
                    <div class="price">
                    	<table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                          <tbody><tr style="font-family:'宋体';">
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_3.jpg" width="160" height="140"></div>
                    <div class="name">登机箱拉杆箱</div>
                    <div class="price">
                    	<table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                          <tbody><tr style="font-family:'宋体';">
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_11.jpg" width="160" height="140"></div>
                    <div class="name">粉色hp笔记本</div>
                    <div class="price">
                    	<table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                          <tbody><tr style="font-family:'宋体';">
                ...
                <li>
                	<div class="img"><img src="${pageContext.request.contextPath}/product/p_1.jpg" width="160" height="140"></div>
                    <div class="name">diva少女系香水</div>
                    <div class="price">
                    	<table border="0" style="width:100%; color:#888888;" cellspacing="0" cellpadding="0">
                          <tbody><tr style="font-family:'宋体';">
    ...
    <div class="sell_style clearfix">
     <div class="advisory sell">
      <div class="left_sell">
      <a href="#">
      <img src="${pageContext.request.contextPath}/images/tm_1.png"></a>
      </div>
     ...
     <div class="left_sell">
      <a href="#">
      <img src="${pageContext.request.contextPath}/images/tm_2.png"></a>
      </div>
      <div class="right_sell">
       	 享受VIP专属特权
       <br>       
