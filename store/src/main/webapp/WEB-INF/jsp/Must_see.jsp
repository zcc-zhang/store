	...
	$(function()
			{
				...
				$(".Navigation_name li").eq(2).addClass("on");
			});
</script>
</head>
...
<!--每日必看产品-->
 <div class="Product_carousel" id="">
   ...
   <div class="bd">
    <ul>
     <li><a href="#"><div style="background-image: url(AD_img/AD-111.jpg); background-repeat:no-repeat; background-position:center; height:456px; background-color:#FFF"></div></a></li>
     <li><a href="#"><div style="background-image: url(AD_img/AD-112.jpg); background-repeat:no-repeat; background-position:center; height:456px; background-color:#a1e2ff"></div></a></li>
    </ul>
   </div>
   ...
   <div class="list">
      <ul class="list_style">
       <li class="p_info_u">
        ...
        <a href="#" class="p_img"><img src="product/p_14.jpg"></a>
        ...
        <div class="Brands_logo"><a href="#"><img src="product/logo/34.jpg"  width="130"/></a></div>
       </li>
         <li class="p_info_u">
         <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_15.jpg"></a>
        <a href="#" class="name">御泥坊 玫瑰滋养+红石榴亮颜美肤套装 深层补水滋润 提亮肤色</a>
        </div>
        <div class="Numeral"><span class="price"><i>￥</i>123.00</span><span class="Sales">销量<i>345</i>件</span></div>
         <div class="Brands_logo"><a href="#"><img src="product/logo/34.jpg"  width="130"/></a></div>
         ...
         <li class="p_info_u">
         <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_16.jpg"></a>
        <a href="#" class="name">御泥坊 玫瑰滋养+红石榴亮颜美肤套装 深层补水滋润 提亮肤色</a>
        </div>
        <div class="Numeral"><span class="price"><i>￥</i>123.00</span><span class="Sales">销量<i>345</i>件</span></div>
         <div class="Brands_logo"><a href="#"><img src="product/logo/34.jpg"  width="130"/></a></div>
         ...
         <li class="p_info_u">
         <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_17.jpg"></a>
        <a href="#" class="name">御泥坊 玫瑰滋养+红石榴亮颜美肤套装 深层补水滋润 提亮肤色</a>
        </div>
        <div class="Numeral"><span class="price"><i>￥</i>123.00</span><span class="Sales">销量<i>345</i>件</span></div>
         <div class="Brands_logo"><a href="#"><img src="product/logo/34.jpg"  width="130"/></a></div>
         ...
         <li class="p_info_u">
         <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_18.jpg"></a>
        <a href="#" class="name">御泥坊 玫瑰滋养+红石榴亮颜美肤套装 深层补水滋润 提亮肤色</a>
        </div>
        <div class="Numeral"><span class="price"><i>￥</i>123.00</span><span class="Sales">销量<i>345</i>件</span></div>
         <div class="Brands_logo"><a href="#"><img src="product/logo/644.jpg"  width="130"/></a></div>
       </li>
         <li class="p_info_u">
         <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_19.jpg"></a>
        <a href="#" class="name">御泥坊 玫瑰滋养+红石榴亮颜美肤套装 深层补水滋润 提亮肤色</a>
        </div>
        <div class="Numeral"><span class="price"><i>￥</i>123.00</span><span class="Sales">销量<i>345</i>件</span></div>
         <div class="Brands_logo"><a href="#"><img src="product/logo/245.jpg"  width="130"/></a></div>
       </li>
        <li class="p_info_u">
        <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_24.jpg"></a>
        <a href="#" class="name">御泥坊 玫瑰滋养+红石榴亮颜美肤套装 深层补水滋润 提亮肤色</a>
        </div>
        <div class="Numeral"><span class="price"><i>￥</i>123.00</span><span class="Sales">销量<i>345</i>件</span></div>
         <div class="Brands_logo"><a href="#"><img src="product/logo/152.jpg"  width="130"/></a></div>
       </li>
        <li class="p_info_u">
        <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_26.jpg"></a>
        <a href="#" class="name">御泥坊 玫瑰滋养+红石榴亮颜美肤套装 深层补水滋润 提亮肤色</a>
        </div>
        <div class="Numeral"><span class="price"><i>￥</i>123.00</span><span class="Sales">销量<i>345</i>件</span></div>
         <div class="Brands_logo"><a href="#"><img src="product/logo/42.jpg"  width="130"/></a></div>
       </li>
          <li class="p_info_u">
         <div class="p_info_content">
        <a href="#" class="p_img"><img src="product/p_19.jpg"></a>
