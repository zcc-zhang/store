...
<head>
    ...
    <script src="{pageContext.request.contextPath}/js/jqzoom.js" type="text/javascript"></script>
                ...
                <ul class="clearfix">
                    ...
                    <li class="hd_menu_tit phone_c" data-addclass="hd_menu_hover"><a
                        ...
                        <div class="hd_menu_list erweima">
                            <ul>
                                <img src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/erweima.png" width="100px" height="100"/>
                            </ul>
                        </div>
                    </li>
                </ul>
