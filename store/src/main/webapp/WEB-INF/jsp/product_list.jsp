		...
		<div id="Filter_style">
			...
			<div class="page_recommend">
				...
				<div class="bd">
					<ul>
						<li>
							<div class="img">
								<a href="#"><img src="product/p_4.jpg" width="120"
									height="120" /></a>
							</div>
							<div class="pro_info">
			...
			<div class="Filter">
				...
				<div class="Filter_list clearfix">
					...
					<div class="p_f_name">
						<a href="#">袋装</a> <a
							href="${pageContext.request.contextPath}/showCommodityListServlet?commodityAttribute=盒装">盒装</a>
						<a
							href="${pageContext.request.contextPath}/showCommodityListServlet?commodityAttribute=瓶装">瓶装</a>
				...
				<div class="Filter_list clearfix">
					...
					<div class="p_f_name">
						<a
							href="${pageContext.request.contextPath}/showCommodityListServlet?commodityPrice=between 0 and 50">0-50</a>
						<a
						...
						<div class="ranking_list">
							...
							<c:forEach items="${list}" var='list'  varStatus="idxStatus" >
								<li class="t_p on"><em class="icon_ranking">${idxStatus.index+1 }</em>
									...
									<dd class="clearfix">
										<a href="#"><img src="${list.commodityImg }" width="90"
											height="90" /></a> <span class="Price">￥${list.commodityPrice}</span>
									</dd></li>
							</c:forEach>
								<!-- <li class="t_p on"><em class="icon_ranking">1</em>
									...
									<dd class="clearfix">
										<a href="#"><img src="product/p_29.jpg" width="90"
							...
							<li class="gl-item">
								<div class="Borders">
									...
									<form id="myFrom">
										...
										<input type="hidden" name="commodityPrice" value="${list.commodityPrice}" /> 
										<input type="hidden" name="productName" value="${list.productName}" />
										<input type="hidden" name="commodityAttribute" value="${list.commodityAttribute}" /> 
										<input type="hidden" name="merchant_ID" value="${list.merchantId}" />
										<input type="hidden" name="commodityTypeID" value="${list.commodityTypeID}" />
										<input type="hidden" name='collectNumber' value='${list.collectNumber }'/>
										<input type="hidden" name="commodityImg" value="${list.commodityImg}" />
									</form>
									<div class="Price">
									...
									<div class="name">
										<a
											href="${pageContext.request.contextPath}/productDetailedServlet?commodityId=${list.commodityID}">${list.productName}</a>
									</div>
									<div class="Review">
										已有<a href="#">${list.commodityEvaluation}</a>评论
									</div>
									<div class="p-operate">
										<a href="javascript:void(0)" class="p-o-btn Collect"><em></em>收藏</a> <a href="javascript:void(0)"
					...
					<div class="Paging">
						<div class="Pagination">
							...
							<c:if test="${page.currentPage >1}">
								<a
									href="${pageContext.request.contextPath}/showCommodityListServlet?currentPage=1
								&commodityAttribute=${commodityAttribute}
								&commodityPrice=${commodityPrice}">首页</a>
								<a
									href="${pageContext.request.contextPath}/showCommodityListServlet
								?currentPage=${page.currentPage - 1}
								&commodityAttribute=${param.commodityAttribute}
								&commodityPrice=${param.commodityPrice}"
									class="pn-prev disabled">上一页</a>
							</c:if>
							<c:forEach begin="${page.pageStartNo}" end="${page.pageEndNo }"
								var='pageCode'>
								<c:if test="${page.pageStartNo eq pageCode}"></c:if>
								<a
									href="${pageContext.request.contextPath}/showCommodityListServlet
							?currentPage=${pageCode}&commodityAttribute=${commodityAttribute}
							&commodityPrice=${commodityPrice}">${pageCode}</a>
							</c:forEach>
							<!--  
							...
							<c:if test="${page.currentPage != page.totalPage && page.totalPage>0}">
								<a
									...
									currentPage=${page.currentPage + 1}
									&commodityAttribute=${commodityAttribute}
									&commodityPrice=${commodityPrice}">下一页</a>
								<a
									href="${pageContext.request.contextPath}/showCommodityListServlet?currentPage=${page.pageEndNo}
							&commodityAttribute=${commodityAttribute}
							&commodityPrice=${commodityPrice}">尾页</a>
							</c:if>
